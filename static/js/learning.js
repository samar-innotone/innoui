document.addEventListener('DOMContentLoaded', (event) => {
    let startLearningBtn = document.getElementById('new-learning-btn');
    let formFields = document.getElementById('grade-subject-fields');
    let errorMessage = document.getElementById('error-message');
    let chatForm = document.getElementById('learning-form');
...
//    }
    ...
    window.startNewChat = function() {
        fetch('/learning/get-grades-and-subjects/')
...
//                addTextToSpeechEventListeners();
        ...
        document.getElementById('new_learning_state').value = 'Start Learning';

        return true;
    };

    document.getElementById('new-learning-form').onsubmit = window.startNewChat;
